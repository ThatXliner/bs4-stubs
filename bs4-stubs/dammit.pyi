...
class EntitySubstitution:
    ...
    def substitute_xml_containing_entities(
        cls, value: Any, make_quoted_attribute: bool = ...
    ): ...
    @classmethod
...
class EncodingDetector:
    ...
    def find_declared_encoding(
        cls, markup: Any, is_html: bool = ..., search_entire_document: bool = ...
    ): ...
...
class UnicodeDammit:
    ...
    @classmethod
    def detwingle(
        cls, in_bytes: Any, main_encoding: str = ..., embedded_encoding: str = ...
    ): ...
